/*
etx_media_publication_controller
Diese JavaScript-Datei wird in der `boot.php` des AddOns `etx_media_publication_controller` im Backend eingebunden (rex_view::addJsFile)
