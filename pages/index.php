...
echo rex_view::title($addon->i18n('title')); // $addon->i18n('title') ist eine Kurzform für rex_i18n::msg('dbac_title')

// Die Subpages werden nicht mehr über den "subpage"-Parameter gesteuert, sondern über "page" (getrennt mit einem Slash, z. B. page=dbac/config)
