...
$field = $form->addFieldset($addon->i18n('config_title'));

// Checkboxen initialisieren
$field = $form->addCheckboxField('mediapool');
$field->addOption($addon->i18n('config_medienpool'), 1);

$field = $form->addCheckboxField('page');
$field->addOption($addon->i18n('config_site'), 1);


$field = $form->addCheckboxField('module');
$field->addOption($addon->i18n('config_module'), 1);
...
->addTabElement('Zugriff', MForm::factory()
    ...
    ->addColumnElement(6, MForm::factory()
        ...
        ->addTextField("\$idStatic.deactivation_date", [
            'label' => '{$addon->i18n('deactivation_date')}',
            'class' => 'form-control flatpickr',
            'data-enableTime' => 'true',
            'data-locale' => 'de',
        ])->setFull()
...
$field = $form->addFieldset($addon->i18n('config_input_title'));
